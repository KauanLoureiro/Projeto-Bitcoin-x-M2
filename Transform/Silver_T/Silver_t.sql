...
DROP TABLE IF EXISTS M2_cn_DOL;
CREATE TABLE IF NOT EXISTS M2_cn_DOL AS 

SELECT
    t1.Month,
    t1.M2_cn_M*t2.CNYUSD_M AS M2_cn_M_DOL
FROM M2_cn_CNY AS t1

LEFT JOIN fx_SILVER AS t2
ON t1.Month = t2.Month;

-- JPY to DOL
DROP TABLE IF EXISTS M2_jp_DOL;
CREATE TABLE IF NOT EXISTS M2_jp_DOL AS 

SELECT
    t1.Month,
    t1.M2_jp_M*t2.JPYUSD_M AS M2_jp_M_DOL
FROM M2_jp_JPY AS t1
